...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$error) {
        // Insert plan
        $sql = "INSERT INTO plans (name, speed, price, description, status) VALUES (?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('ssdss', $name, $speed, $price, $description, $status);
...
<head>
    ...
    <title>Add Plan - ISP Management System</title>
